...
public class RegularDTO {
    ...
    @Pattern(regexp="^[0-9a-zA-Z]{2,3}$",message="Frequency can only contain letters or digits of 2 or 3 characters.")
    private String frequency;
    @Pattern(regexp="^[a-zA-Z]{2}$",message="Weekend Adjust can only contain 2 letters characters.")
    private String weekendAdj;
    @Pattern(regexp = "^[0-9]{4}-[0-9]{2}-[0-9]{2}$",message = "Start must be a date in format yyyy-dd-mm")
    private String start;
    @Pattern(regexp = "^[0-9]{4}-[0-9]{2}-[0-9]{2}$",message = "Last created must be a date in format yyyy-dd-mm")
